      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12">
          ...
          <div className="mt-8 md:mt-0 flex gap-8">
            <a href="#" className="text-sm text-gray-400 hover:text-white transition-colors">Investment</a>
            <a href="#" className="text-sm text-gray-400 hover:text-white transition-colors">Technology</a>
            <a href="#" className="text-sm text-gray-400 hover:text-white transition-colors">Compliance</a>
