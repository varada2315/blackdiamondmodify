          ...
          <div className="grid lg:grid-cols-3 gap-12 items-start">
              ...
              <div className="bg-card border border-white/10 p-8 rounded-2xl space-y-6 shadow-2xl">
                ...
                <div className="p-4 bg-accent/5 rounded-xl border border-accent/20 flex gap-4">
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Based on BlackDiamondGranites operational data and 250 TPH plant capacity benchmarks.
                  </p>
                </div>
              </div>
            ...
            <div className="lg:col-span-2 grid md:grid-cols-2 gap-6">
              ...
              <motion.div 
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                className="bg-accent/10 border border-accent/20 p-8 rounded-2xl flex flex-col justify-center text-center space-y-4"
              >
                <div className="w-12 h-12 bg-accent/20 rounded-full flex items-center justify-center text-accent mx-auto">
                  <ShieldAlert className="w-6 h-6" />
                </div>
                <div>
                  <h4 className="text-white font-bold uppercase tracking-wider text-sm mb-2">Preservation Index</h4>
                  <p className="text-xs text-muted-foreground">Significant reduction in regional water stress and illegal mining activities.</p>
                </div>
              </motion.div>
            </div>
          </div>
