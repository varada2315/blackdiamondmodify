      ...
      <div className="relative z-30 container mx-auto px-6 text-center max-w-5xl">
        <div>
          ...
          <p className="text-sm md:text-base text-tertiary/60 font-medium tracking-wide max-w-2xl mx-auto mb-8 border-t border-white/5 pt-4">
            South India’s only super primary processing unit (550 TPH) operating on a 6-acre site, delivering 800+ TPH total capacity while transforming granite waste into controlled, compliant construction resources that protect groundwater and prevent ecosystem damage.
          </p>
        </div>
