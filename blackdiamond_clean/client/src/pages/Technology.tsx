          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-heading font-bold text-white mb-8">
                Super Primary Processing Unit – 550 TPH
              </h2>
              <p className="text-tertiary/70 text-lg leading-relaxed mb-8">
                Our super primary processing unit delivers 550 tons per hour with precision engineering and intelligent automation. Integrated with downstream systems, the overall facility achieves 800+ TPH total capacity while maintaining stringent quality standards.
              </p>
